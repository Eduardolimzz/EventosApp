...
import com.eventosapp.config.DotenvConfig;

@Configuration
public class DataSourceConfig {

    private final String host = DotenvConfig.get("MYSQLHOST");
    private final String port = DotenvConfig.get("MYSQLPORT");
    private final String database = DotenvConfig.get("MYSQLDATABASE");
    private final String user = DotenvConfig.get("MYSQLUSER");
    private final String password = DotenvConfig.get("MYSQLPASSWORD");
